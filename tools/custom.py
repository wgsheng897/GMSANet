...
def parse_args():
    ...
    parser.add_argument('--p', help='dir for pretrained model', default='./pretrained_models/cityscapes/best.pt', type=str)
...
if __name__ == '__main__':
    ...
    print('glob： ',args.r+'*'+args.t)
    sv_path = args.r+'outputs/'
    # sv_path = args.r+'myoutputs/'
...
#             print('img_name: ',img_name)
            ...
            print('图片名称：image_name = ',image_name)
...
#                                cv2.IMREAD_COLOR)
            ...
            if not os.path.exists(sv_path):
                os.mkdir(sv_path)
            sv_img.save(sv_path+image_name)
            print('保存生成的语义图片：',sv_path+image_name)
        print('Ending!!!')
